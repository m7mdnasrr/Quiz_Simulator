/* ═══════════════════════════════════════════════════════════════
   ...
   Schema (every question object):
     {
       id:          "FSIEM-n",
       category:    "<one of domainOrder in registry.js>",
       type:        "single" | "multiple",
       image:       "1" | null,             // → images/fsiem/1.png
       text:        "…question stem…",
       choices:     ["A","B","C","D"],
...
(function () {
  ...
  const C = {
    DEPLOY:  'Deployment & Architecture',
    DATA:    'Data Collection & Parsers',
    CMDB:    'CMDB & Discovery',
    ANALYTICS:'Analytics & Rules',
    INCIDENT:'Incidents & Remediation',
  ...
  const QUESTIONS = [
    ...
    /* ═══════════════════════════════════════════════════════════
       ...
       ═══════════════════════════════════════════════════════════ */
    {
      id:'FSIEM-1', category:C.CMDB, type:'single', image:'1',
      ...
      correct:[0],
      explanation:'The "Group:" prefix in the search filter refers to a CMDB device group — a logical grouping of devices defined in the FortiSIEM configuration management database.'
    },
    {
      id:'FSIEM-51', category:C.CMDB, type:'single', image:null,
    ...
    {
      id:'FSIEM-73', category:C.CMDB, type:'single', image:'73',
    ...
    /* ═══════════════════════════════════════════════════════════
       ...
       ═══════════════════════════════════════════════════════════ */
    {
      id:'FSIEM-6', category:C.DATA, type:'single', image:null,
    ...
    {
      id:'FSIEM-27', category:C.DATA, type:'single', image:'27',
    ...
    {
      id:'FSIEM-63', category:C.DATA, type:'single', image:'63',
    ...
    {
      id:'FSIEM-4', category:C.ANALYTICS, type:'single', image:null,
    ...
    {
      id:'FSIEM-8', category:C.ANALYTICS, type:'single', image:'8',
    ...
    {
      id:'FSIEM-9', category:C.ANALYTICS, type:'single', image:'9',
    ...
    {
      id:'FSIEM-10', category:C.ANALYTICS, type:'single', image:'10',
    ...
    {
      id:'FSIEM-13', category:C.ANALYTICS, type:'single', image:null,
    ...
    {
      id:'FSIEM-16', category:C.ANALYTICS, type:'multiple', image:null,
    ...
    {
      id:'FSIEM-18', category:C.ANALYTICS, type:'single', image:'18',
    ...
    {
      id:'FSIEM-19', category:C.ANALYTICS, type:'single', image:null,
    ...
    {
      id:'FSIEM-22', category:C.ANALYTICS, type:'single', image:'22',
    ...
    {
      id:'FSIEM-25', category:C.ANALYTICS, type:'multiple', image:null,
    ...
    {
      id:'FSIEM-26', category:C.ANALYTICS, type:'single', image:'26',
    ...
    {
      id:'FSIEM-30', category:C.ANALYTICS, type:'single', image:null,
    ...
    {
      id:'FSIEM-32', category:C.ANALYTICS, type:'single', image:'32',
    ...
    {
      id:'FSIEM-34', category:C.ANALYTICS, type:'single', image:null,
    ...
    {
      id:'FSIEM-40', category:C.ANALYTICS, type:'single', image:'40',
    ...
    {
      id:'FSIEM-41', category:C.ANALYTICS, type:'single', image:null,
    ...
    {
      id:'FSIEM-43', category:C.ANALYTICS, type:'single', image:null,
    ...
    {
      id:'FSIEM-44', category:C.ANALYTICS, type:'multiple', image:null,
    ...
    {
      id:'FSIEM-45', category:C.ANALYTICS, type:'single', image:'45',
    ...
    {
      id:'FSIEM-46', category:C.ANALYTICS, type:'single', image:null,
    ...
    {
      id:'FSIEM-48', category:C.ANALYTICS, type:'single', image:'48',
    ...
    {
      id:'FSIEM-49', category:C.ANALYTICS, type:'single', image:'49',
    ...
    {
      id:'FSIEM-52', category:C.ANALYTICS, type:'single', image:'52',
    ...
    {
      id:'FSIEM-53', category:C.ANALYTICS, type:'multiple', image:null,
    ...
    {
      id:'FSIEM-58', category:C.ANALYTICS, type:'single', image:null,
    ...
    {
      id:'FSIEM-59', category:C.ANALYTICS, type:'single', image:null,
    ...
    {
      id:'FSIEM-60', category:C.ANALYTICS, type:'multiple', image:null,
    ...
    {
      id:'FSIEM-61', category:C.ANALYTICS, type:'multiple', image:null,
    ...
    {
      id:'FSIEM-69', category:C.ANALYTICS, type:'single', image:'69',
    ...
    {
      id:'FSIEM-74', category:C.ANALYTICS, type:'multiple', image:'74',
    ...
    {
      id:'FSIEM-76', category:C.ANALYTICS, type:'single', image:null,
    ...
    {
      id:'FSIEM-20', category:C.INCIDENT, type:'multiple', image:'20',
    ...
    /* ═══════════════════════════════════════════════════════════
       ...
       ═══════════════════════════════════════════════════════════ */
    {
      id:'FSIEM-17', category:C.REPORTS, type:'single', image:'17',
    ...
    /* ═══════════════════════════════════════════════════════════
       ...
       ═══════════════════════════════════════════════════════════ */
    {
      id:'FSIEM-5', category:C.FABRIC, type:'multiple', image:null,
    ...
    {
      id:'FSIEM-29', category:C.FABRIC, type:'single', image:'29',
    ...
    {
      id:'FSIEM-31', category:C.FABRIC, type:'single', image:null,
    ...
    {
      id:'FSIEM-38', category:C.FABRIC, type:'multiple', image:'38',
    ...
    {
      id:'FSIEM-42', category:C.FABRIC, type:'single', image:null,
    ...
    {
      id:'FSIEM-64', category:C.FABRIC, type:'multiple', image:null,
    ...
    /* ═══════════════════════════════════════════════════════════
       ...
       ═══════════════════════════════════════════════════════════ */
    {
      id:'FSIEM-62', category:C.DEPLOY, type:'multiple', image:null,
    ...
    {
      id:'FSIEM-71', category:C.DEPLOY, type:'single', image:null,
